      ...
      <div className="mx-auto mt-5 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-200 px-4 sm:py-6 sm:px-6">
          <button
            ...
            type="submit"
            className="rounded-md my-5 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#10455F]"
          >
            Add New Address
          </button>
              ...
              <div className="space-y-12">
                ...
                <div className="mt-8 flex items-center justify-end gap-x-6">
                  <button
                    ...
                    className="rounded-md px-3 py-2 text-sm font-semibold text-grey shadow-sm hover:bg-grey-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#10455F]"
                  >
                    Cancel
                  </button>
                  <button
            ...
            <div key={index}>
              ...
              <div className="px-2 flex justify-end">
                ...
                <button
                  ...
                  type="button"
                  className="ps-2 font-medium text-[#10455F] hover:text-[#5a8faa]"
                >
                  Remove
                </button>
              </div>
